...
Codigos_canton <- datos_totales%>%dplyr::select(NAME_2=Canton, CCanton)
#Archivos para el mapa
distritos_st <-st_read('Data/distritos_shape/gadm41_CRI_2.shp') 
cantones_st  <- merge(distritos_st,codigos_canton,by="NAME_2", all=T)
